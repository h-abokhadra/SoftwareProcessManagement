/**
 * Test class used in SYST 38634 final exam
 * 
 * @author dancye, 2021
 *
 */
public class GraduationCalculator {
	/**
	 * Method to determine the year of graduation for a program that is 5 terms If
	 * students start in January, they graduate the next calendar year. If they
	 * start in September, they graduate in two calendar years. If the user enters
	 * some other startingMonth, the program throws an invalidStartMonthException
	 * 
	 * @param startingYear
	 * @param startingMonth
	 * @return
